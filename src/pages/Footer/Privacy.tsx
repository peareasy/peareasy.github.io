...
const Privacy = () => {
  ...
  <h1
    style={{ margin: "0cm", textAlign: "center", pageBreakAfter: "auto" }}
  >
    <span
      lang="EN-US"
  ...
  >
    <span lang="UK" style={{ fontFamily: '"Arial",sans-serif' }}>
      &nbsp;
    </span>
  </p>
  <p
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      PearEasy Aps&nbsp;(“us”, “we”, or “our”) operates&nbsp;easysbc.io and
      easySBC mobile application&nbsp;(hereinafter referred to as “
      <b>Service</b>”).
    </span>
  </p>
  <p
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      Our Privacy Policy governs your visit to&nbsp;easysbc.io and easySBC
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      PearEasy Aps&nbsp;will take all the steps reasonably necessary to ensure
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      (ii)<span style={{ font: '7.0pt "Times New Roman"' }}>&nbsp;&nbsp;</span>
    </span>
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
  ...
  >
    ...
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      ...
      hold about you as of the date of your request from our records and direct
      any service providers to do the same. In some cases, deletion may be
      accomplished through de-identification of the information. If you choose
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      By email: peareasy.sbc@gmail.com
    </span>
  </p>
  <p
    className="MsoNormal"
  ...
  >
    <span lang="EN-US" style={{ fontFamily: '"Arial",sans-serif' }}>
      By visiting this page on our website: https://easysbc.io/#/contact
    </span>
  </p>
  <p
    className="MsoNormal"
  ...
  >
    <b>
      <span
        lang="EN-US"
        style={{ fontFamily: '"Arial",sans-serif', background: "lime" }}
      >
        &nbsp;
      </span>
    </b>
