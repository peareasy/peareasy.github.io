...
const Home = () => {
  ...
  const importPlayersView = (
    ...
    <div className="flex flex-row space-between justify-center space-x-2 pl-32 pr-32 w-screen ">
      ...
      <div className="bg-gray-800 flex flex-col mt-2 mb-24 w-60 rounded-sm laptop:h-80 h-80">
      ...
      <div className="flex flex-col bg-gray-900  mb-8 rounded-sm">
        <div className="flex flex-row space-x-2  pr-2 pl-2 justify-between">
          <div className="bg-gray-800 w-60 flex flex-col z-10 mt-2 laptop:h-80 h-80 rounded-sm">
          ...
          <div className="bg-gray-800 w-60 flex flex-col z-10 mt-2 shadow-2xl laptop:h-80 h-80 rounded-sm">
      ...
      <div className="bg-gray-800 flex flex-col mt-2 mb-24 w-60  laptop:h-80 h-80 rounded-sm">
        <div className="ml-4 mr-4 mt-8 h-16">
