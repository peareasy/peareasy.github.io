...
const Home = () => {
  ...
  const importPlayersView = (
    ...
    <div className="flex flex-row space-between justify-center space-x-2 pl-32 pr-32 w-screen">
      ...
      <div className="bg-zinc-800 flex flex-col mt-2 mb-24 w-52 rounded-sm laptop:h-72 h-72">
      ...
      <div className="bg-zinc-800 flex flex-col mt-2 mb-24 w-52  laptop:h-72 h-72 rounded-sm">
        <div className="ml-4 mr-4 mt-8 h-16">
